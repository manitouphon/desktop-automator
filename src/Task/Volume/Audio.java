...
public class Audio {
    ...
    //Line 88 for master search config

    public static void main(String[] args) {
        System.out.println(System.getProperty("os.name"));
        System.out.println(getOutputVolumeForMac());
        setOutputVolumeForMac(50.0f);
    }
     ...
     *
     * @param value
     * Value Range: 0.1f -> 1.0f
     */
    public static void setOutputVolumeForMac(float value)
    {

        int volume = (int) (value * 100);
        System.out.println("Set vol:" + volume);

        String command = "set volume output volume " + volume ;
    ...
    public static float getOutputVolumeForMac(){
        try
        {
            ...
            float returner = Float.parseFloat(String.valueOf(output))/100.0f;
            return returner;
        }
        catch(Exception e)
        {
